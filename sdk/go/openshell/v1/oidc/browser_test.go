...
func TestBrowserCommandForOS_WindowsDoesNotUseCommandShell(t *testing.T) {
	name, args := browserCommandForOS("windows", "https://auth.example.com/authorize?client_id=test&state=abc")
